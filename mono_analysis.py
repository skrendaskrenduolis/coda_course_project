...
# ONLY ONE LINE UNCOMMENTED
pokemon_data_mono = pokemon_data[pokemon_data["Type 1"].isin(["Fighting", "Psychic"])]
# pokemon_data_mono = pokemon_data[pokemon_data["Type 2"].isin(["Flying", "Poison"])]

covariates = pokemon_data_mono.iloc[:, 0:3]
closed_abilities = pokemon_data_mono.iloc[:, 3:].coda.closure(100)
